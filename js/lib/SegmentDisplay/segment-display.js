...
define(function(){
  ...
  var SevenSegment    = 7;
  var FourteenSegment = 14;
  var SixteenSegment  = 16;

  // Segment corner types
  var SymmetricCorner = 0;
  var SquaredCorner   = 1;
  var RoundedCorner   = 2;

  // Segment display color scheme
  ...
  return {
    ...
    SymmetricCorner: SymmetricCorner,
    SquaredCorner: SquaredCorner,
